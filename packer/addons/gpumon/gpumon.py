...
INSTANCE_ID = urlopen(BASE_URL + 'instance-id').read().decode('utf-8')
IMAGE_ID = urlopen(BASE_URL + 'ami-id').read().decode('utf-8')
INSTANCE_TYPE = urlopen(BASE_URL + 'instance-type').read().decode('utf-8')
INSTANCE_AZ = urlopen(BASE_URL + 'placement/availability-zone').read().decode('utf-8')
EC2_REGION = INSTANCE_AZ[:-1]
# print(f'instance_id {INSTANCE_ID}')
# print(f'instance_iaz {INSTANCE_AZ}')
# print(f'ec2_region {EC2_REGION}')
